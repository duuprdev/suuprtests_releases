# SuuprTests Releases Changelog

All notable changes to the SuuprTests application will be documented in this file. 
...
## 1.0.0+2
-   Fixed issue with simulators dropdown    
-   Added documentation link to the about modal
-   Fixed issue with the waitFor test step
